...
def _prompt_(eval_category, anchor_images, csv_folder_path, model_name, model_temperature, API_KEY):
    ...
    anchor_images_info_dict = {
        ...
        "pegmatitic_structure":[("Anchors/strong_pegmatite.jpg", "giant pegmatitic"),
                               ("Anchors/medium_pegmatite.jpg", 'medium-coarse grained structure'),
                               ("Anchors/none_pegmatite.jpg", "very fine-grained pegmatitic structure")]
    }
